...
::: {.center}
![GDBuddy workflow diagram illustrating the execution pipeline from code push through GitHub Actions to hardware execution and feedback](Workflow.png){#fig-workflow-diagram}
:::
