...
![GDBuddy system architecture showing three layers: GitHub cloud platform, Linux host with Docker container, and embedded hardware device connected via USB](System_Design3.drawio.jpeg){#fig-gdbuddy-architecture width=90% fig-align="center"}
