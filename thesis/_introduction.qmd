...
![Comparison of Simulation, Emulation, and Hardware-in-the-Loop testing approaches](SimVsEmVsHIL.jpeg){#fig-sim-em-hil width=130%}
...
### Industry Context
![Testing workflow showing the progression from Software-in-the-Loop through Hardware-in-the-Loop to Vehicle-in-the-Loop testing](HILvsSIL.jpg){#fig-hil-vs-sil}
...
### Workflow
![GDBuddy workflow diagram showing the integration of GitHub, Docker container, and physical hardware execution](workflow_graphic.jpg){#fig-gbuddy-workflow}
